...
Tool classes are responsible for collecting data, providing functionality, and exposing their capabilities through REST
endpoints that the frontend can consume.
