          ...
          <CardContent className="wdt:space-y-4">
            ...
            {error && (
              <details className="wdt:mt-4">
                <summary className="wdt:cursor-pointer wdt:text-sm wdt:text-red-600 wdt:hover:text-red-800">
                  Technical Details
                </summary>
            ...
            <div className="wdt:flex wdt:gap-2 wdt:mt-6">
              {resetError && (
                <Button
                  onClick={resetError}
                  variant="outline"
                  className="wdt:border-red-300 wdt:text-red-700 wdt:hover:bg-red-100"
                >
                  Try Again
                </Button>
              )}
              <Button
                ...
                className="wdt:bg-red-600 wdt:hover:bg-red-700 wdt:text-white"
              >
                Reload Page
              </Button>
            </div>
