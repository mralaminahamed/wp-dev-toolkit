			...
			<div className='wdt:max-w-6xl wdt:mx-auto wdt:space-y-8'>
				<div className='wdt:space-y-4 wdt:text-center md:wdt:text-left'>
					<div className='wdt:flex wdt:items-center wdt:justify-center md:wdt:justify-start wdt:gap-4'>
						<div className='wdt:relative'>
							<div className='wdt:p-4 wdt:bg-gradient-to-br wdt:from-pink-50 wdt:to-pink-100/50 wdt:dark:from-pink-950/20 wdt:dark:to-pink-900/10 wdt:rounded-2xl wdt:border wdt:border-pink-200/50 wdt:dark:border-pink-800/30'>
								<Palette className='wdt:w-8 wdt:h-8 wdt:text-pink-600 wdt:dark:text-pink-400' />
							</div>
							<div className='wdt:absolute wdt:-top-1 wdt:-right-1 wdt:w-3 wdt:h-3 wdt:bg-pink-500 wdt:rounded-full wdt:animate-pulse'></div>
						</div>
						<div>
					...
					<p className='wdt:text-lg wdt:text-muted-foreground wdt:max-w-3xl wdt:mx-auto md:wdt:mx-0 wdt:leading-relaxed'>
						This component demonstrates the WordPress Development Toolkit design
						system and wdt prefix in action
					</p>
					<div className='wdt:flex wdt:items-center wdt:justify-center md:wdt:justify-start wdt:gap-2 wdt:mt-4'>
						<Palette className='wdt:w-4 wdt:h-4 wdt:text-pink-500' />
						<span className='wdt:text-sm wdt:text-pink-600 wdt:dark:text-pink-400'>
				...
				<div className='wdt:mt-6 wdt:grid wdt:grid-cols-1 md:wdt:grid-cols-3 wdt:gap-6'>
					<div className='wdt:bg-primary-500 wdt:text-white wdt:p-6 wdt:rounded-lg wdt:shadow-md'>
						<h2 className='wdt:text-xl wdt:font-bold wdt:mb-2'>
							Primary Color
						</h2>
						<p className='wdt:text-primary-100'>
							This uses our primary color palette
						</p>
						<button className='wdt:mt-4 wdt:bg-white wdt:text-primary-600 wdt:px-4 wdt:py-2 wdt:rounded wdt:shadow hover:wdt:bg-primary-50'>
							Primary Button
						</button>
					</div>
					...
					<div className='wdt:bg-secondary-100 wdt:text-secondary-800 wdt:p-6 wdt:rounded-lg wdt:shadow-md'>
						...
						<p className='wdt:text-secondary-600'>
							This uses our secondary color palette
						</p>
						<button className='wdt:mt-4 wdt:bg-secondary-500 wdt:text-white wdt:px-4 wdt:py-2 wdt:rounded wdt:shadow hover:wdt:bg-secondary-600'>
							Secondary Button
						</button>
					</div>
					...
					<div className='wdt:bg-white wdt:p-6 wdt:rounded-lg wdt:shadow-md wdt:border wdt:border-gray-200'>
						...
						<div className='wdt:space-y-2'>
							<div className='wdt:flex wdt:items-center wdt:gap-2'>
								...
								<span className='wdt:text-success-500 wdt:font-medium'>
									Success
								</span>
							</div>
							<div className='wdt:flex wdt:items-center wdt:gap-2'>
								<span className='wdt:w-4 wdt:h-4 wdt:rounded-full wdt:bg-danger-500'></span>
								<span className='wdt:text-danger-500 wdt:font-medium'>
									Danger
								</span>
							</div>
							<div className='wdt:flex wdt:items-center wdt:gap-2'>
								<span className='wdt:w-4 wdt:h-4 wdt:rounded-full wdt:bg-warning-500'></span>
								<span className='wdt:text-warning-500 wdt:font-medium'>
									Warning
								</span>
							</div>
							<div className='wdt:flex wdt:items-center wdt:gap-2'>
				...
				<div className='wdt:mt-8 wdt:p-6 wdt:bg-white wdt:rounded-lg wdt:shadow-md'>
					<h2 className='wdt:text-xl wdt:font-bold wdt:mb-4'>
						Tailwind Features with Prefix
					</h2>

					<div className='wdt:space-y-6'>
						<div>
							<h3 className='wdt:text-lg wdt:font-semibold wdt:mb-2'>
								Flexbox & Grid
							</h3>
							<div className='wdt:flex wdt:flex-wrap wdt:gap-2 wdt:mb-4'>
								<div className='wdt:bg-blue-100 wdt:p-2 wdt:rounded'>
									Item 1
								</div>
								<div className='wdt:bg-blue-100 wdt:p-2 wdt:rounded'>
									Item 2
							...
							<div className='wdt:grid wdt:grid-cols-4 wdt:gap-2'>
								<div className='wdt:bg-green-100 wdt:p-2 wdt:rounded wdt:text-center'>
									1
								</div>
								<div className='wdt:bg-green-100 wdt:p-2 wdt:rounded wdt:text-center'>
									2
