...
const Terminal: React.FC = () => {
  ...
  const clearTerminal = () => {
    setOutput('WordPress Development Toolkit Terminal\nType a command and press Enter...\n');
  };
  ...
  const terminalInputClasses = terminalTheme === 'dark'
            ...
            >
              ...
              {isLoading && (
                <div className="wdt-flex wdt-items-center wdt-text-white wdt-mt-2">
                  <Spinner /> <span className="wdt-ml-2">Executing command...</span>
                </div>
              )}
            </div>
            <form onSubmit={handleSubmit} className={`wdt-flex wdt-items-center ${terminalInputClasses} wdt-rounded-b-lg wdt-p-2`}>
              <div className={`${terminalTheme === 'dark' ? 'wdt-text-green-400' : 'wdt-text-gray-600'} wdt-px-2 wdt-flex wdt-items-center`}>
